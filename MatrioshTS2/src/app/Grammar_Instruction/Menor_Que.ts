...
{
    protected matriz_operacion_menor_que : tipo_operacion_resultado[][] = 
    [   /*                                      void                            nulo                           booleano                         numero                                           cadena                                       identificador                          error 
        ...
        /*numero*/        [ tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.menorque_numerico,        tipo_operacion_resultado.menorque_numerico_cadena, tipo_operacion_resultado.error, tipo_operacion_resultado.error],
        /*String*/        [ tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.menorque_cadena_numerico, tipo_operacion_resultado.menorque_cadena,          tipo_operacion_resultado.error, tipo_operacion_resultado.error],
    ...
    {
        super(p_fila,p_columna,tipo_operacion.MENOR_QUE,p_operador_izq,p_operador_der);
    }
    ...
    public analizar(entorno_padre : Entorno, nivel : number)
    {
        ...
        try
        {
            ...
            let tipo_menor_que :tipo_operacion_resultado;
            ...
            tipo_menor_que = this.matriz_operacion_menor_que[op1.getTipo().getTipo()] [op2.getTipo().getTipo()];

            switch(tipo_menor_que)
            {
                case tipo_operacion_resultado.menorque_numerico:
                    this.entorno_padre = entorno_padre;
                    this.nivel = nivel;

                    _return = new Simbolo(tipo_rol.valor,new Tipo(tipo_dato.BOOLEANO), "");
                    _return.setMensaje("Menor Que exitoso");
                    return _return;
                case tipo_operacion_resultado.menorque_cadena_numerico:
                    this.entorno_padre = entorno_padre;
                    this.nivel = nivel;
                    ...
                    _return.setMensaje("Menor Que exitoso");
                    return _return;
                case tipo_operacion_resultado.menorque_numerico_cadena: 
                    this.entorno_padre = entorno_padre;
                    this.nivel = nivel;
                    ...
                    _return.setMensaje("Menor Que exitoso");
                    return _return;
                case tipo_operacion_resultado.menorque_cadena:
                    this.entorno_padre = entorno_padre;
                    this.nivel = nivel;
                ...
                default:
                    ...
                    _return.setFila(this.fila);
                    _return.setColumna(this.columna);
                    _return.setMensaje("No es posible realizar una Comparación Menor Que del tipo: " + op1.getTipo().getTraduccion()  +  " * " + op2.getTipo().getTraduccion());
                    return _return;
            }
        }
        catch(Exception)
        {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setMensaje("Operacion Menor Que: " + Exception.Message);
            return _return;
        }
    }
    ...
    public traducir(salida : Middle)
    {
        ...
        catch(Error)
        {
            ...
            Middle.getInstance().setOuput("Error Menor Que: " + Error.Mesage);
        }
    }

    public getThis() 
    {
        return new Menor_Que(this.fila,this.columna,this.operador_izq.getThis(),this.operador_der.getThis());
    }
