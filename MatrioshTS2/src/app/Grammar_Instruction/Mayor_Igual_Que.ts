...
class Mayor_Igual_Que extends Expresion
{
    ...
    public analizar(entorno_padre : Entorno, nivel : number)
    {
        ...
        try
        {
            ...
            switch(tipo_mayor_igual_que)
            {
                case tipo_operacion_resultado.mayorigualque_numerico:
                    ...
                    _return.setMensaje("Mayor Igual Que exitoso.");
                    return _return;
                ...
                default:
                    ...
                    _return.setFila(this.fila);
                    _return.setColumna(this.columna);
                    _return.setMensaje("No es posible realizar una Comparación Mayor Igual Que del tipo: " + op1.getTipo().getTraduccion()  +  " * " + op2.getTipo().getTraduccion());
                    return _return;
            }
        }
        catch(Exception)
        {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setMensaje("Operacion Mayor Igual Que: " + Exception.Message);
            return _return;
        }
    }
    ...
    public traducir(salida: Middle)
    {
        ...
        catch(Error)
        {
            ...
            Middle.getInstance().setOuput("Error Mayor Igual Que: " + Error.Mesage);
        }
    }
